...
![rewrap-step-1](https://github.com/nickschirloff/spotify-rewrap/blob/main/git-images/rewrap-step-1.jpg)
* Tap the three dots icon
* Select "Add to other playlist"
![rewrap-step-2](https://github.com/nickschirloff/spotify-rewrap/tree/main/git-images/rewrap-step-2.jpg)
* Create a new Playlist. It should be something along "Wrapped - {Year}"
![rewrap-step-3](https://github.com/nickschirloff/spotify-rewrap/tree/main/git-images/rewrap-step-3.jpg)
