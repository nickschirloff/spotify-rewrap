...
![rewrap-step-1.jpg](https://github.com/nickschirloff/spotify-rewrap/tree/main/git-images/rewrap-step-1.jpg =400x300)
* Tap the three dots icon
* Select "Add to other playlist"
![rewrap-step-2.jpg](https://github.com/nickschirloff/spotify-rewrap/tree/main/git-images/rewrap-step-2.jpg =400x300)
* Create a new Playlist. It should be something along "Wrapped - {Year}"
![rewrap-step-3.jpg](https://github.com/nickschirloff/spotify-rewrap/tree/main/git-images/rewrap-step-3.jpg =400x300)
